...
summary(lm(Fst~timediff, data=y[loc1=="VA-CM"&loc2=="VA-CM"&weird=="yes"])) #P=0.32


jpeg("/scratch/perickso/private/ind_seq/Figures/FigureS12_Fst_over_time.jpg", height=5, width=5, units="in", res=300)
...
summary(lm(Fst~timediff, data=y[loc1=="VA-CM"&loc2=="VA-CM"][weird=="yes"]))
summary(lm(Fst~timediff, data=y[loc1=="VA-CM"&loc2=="VA-CM"][weird=="no"])) #P=0.00866
summary(lm(Fst~timediff, data=y[loc1=="VA-CM"&loc2=="VA-CM"])) 


### Look at early-late within year vs early-early across years FST

y[,pop1.season:=tstrsplit(pop1, split="_")[[3]]]
y[,pop1.year:=tstrsplit(pop1, split="_")[[2]]]

y[,pop2.season:=tstrsplit(pop2, split="_")[[3]]]
y[,pop2.year:=tstrsplit(pop2, split="_")[[2]]]

early.fst<-y[(pop1.season=="early"|pop1.season=="mid")&(pop2.season=="early"|pop2.season=="mid"),Fst]
season.fst<-y[loc1==loc2&pop1.year==pop2.year, Fst]
