...
#make GDS
 #snpgdsVCF2GDS(vcf.fn = "/scratch/perickso/private/ind_seq/popgen/zaprionus.individual.nosingleton.2023.withID.mac3.vcf.gz",  
  #            out.fn="/scratch/perickso/private/ind_seq/popgen/zaprionus.individual.nosingleton.2023.withID.mac3.vcf.gds", 
   #          method="biallelic.only")


#load genofile
genofile <- snpgdsOpen("/scratch/perickso/private/ind_seq/popgen/zaprionus.individual.nosingleton.2023.withID.mac3.vcf.gds" , allow.fork=T)
...
fwrite(pca.dt, file= "/scratch/perickso/private/ind_seq/popgen/PCA_all_mac3.csv")
 #plot overall PCA
...
fwrite(pca.dt2, file= "/scratch/perickso/private/ind_seq/popgen/PCA_all_northamerica_mac3.csv")
...
fwrite(pca.dt3, file= "/scratch/perickso/private/ind_seq/popgen/PCA_all_CMonly_mac3.csv")
...
pdf("/scratch/perickso/private/ind_seq/Figures/Figure_1_PCA_mac3.pdf", height=4, width=12)
...
fwrite(pca.by.chr, file= "/scratch/perickso/private/ind_seq/popgen/PCA_all_bychr_mac3.csv")
...
fwrite(pca.by.chr.na, file= "/scratch/perickso/private/ind_seq/popgen/PCA_all_bychr_northamerica_mac3.csv")
...
fwrite(pca.by.chr.cm, file= "/scratch/perickso/private/ind_seq/popgen/PCA_all_unrelated_bychr_CMonly_mac3.csv")
...
jpeg("/scratch/perickso/private/ind_seq/Figures/FigureS5_PCAbychr_mac3.jpg", height=10, width=12, units="in", res=300)
