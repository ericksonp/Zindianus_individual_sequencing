...
#rewritten again on 12/9/22 to have new genome annotation and run everything on spydur for clean version
...
#bwa index PO1791_Zaprionus_indianus.RepeatMasked.fasta.gz
...
RAW_READS=/scratch/perickso/private/raw_data/Fall2020_sequencing
...
#cd /scratch/perickso/private/raw_data/Fall2020_sequencing
#ls -d ZAP* > file_list.txt


# This is a file with the name all the samples to be processed. one sample name per line
SAMPLE_FILE=/scratch/perickso/private/raw_data/Fall2020_sequencing/file_list.txt
