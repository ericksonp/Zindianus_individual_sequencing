...
unset PYTHONPATH
  ...
  --timepoints 2 10000 \
   ...
   --ftol 1e-3 \
    ...
    -o /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_8knots_10000gen_scaf4_ftol



    echo "plotting final plot for ${pop}"

      cd /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_8knots_10000gen_scaf4_ftol/
      /opt/containers/smc++ plot /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_8knots_10000gen_scaf4_ftol/${pop}_CV10fold_final_plot.png \
      model.final.json \
        -g .08 \
        --csv
    ...
    for i in $(seq 1 $nsamps); do
      echo ${i}
      cd /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_8knots_10000gen_scaf4_ftol/fold${i}/
      /opt/containers/smc++ plot /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_8knots_10000gen_scaf4_ftol/fold${i}/${pop}_fold${i}_final_plot.png \
      model.final.json \
        -g .08 \
        --csv
    done
