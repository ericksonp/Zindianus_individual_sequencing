...
unset PYTHONPATH
  ...
  --timepoints 2 10000 \
   ...
   --spline cubic \
    ...
    -o /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_4knots_10000gen_scaf4_cubic
    ...
    echo "plotting final plot for ${pop}"
      ...
      /opt/containers/smc++ plot /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_4knots_10000gen_scaf4_cubic/${pop}_CV10fold_final_plot.png \
      model.final.json \
        -g .08 \
        --csv
    ...
    for i in $(seq 1 $nsamps); do
      echo ${i}
      cd /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_4knots_10000gen_scaf4_cubic/fold${i}/
      /opt/containers/smc++ plot /scratch/perickso/private/ind_seq/popgen/smcpp/${pop}/${pop}_cv_10folds_4knots_10000gen_scaf4_cubic/fold${i}/${pop}_fold${i}_final_plot.png \
      model.final.json \
        -g .08 \
        --csv
    done
