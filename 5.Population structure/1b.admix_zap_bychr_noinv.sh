...
#Name of pipeline
PIPELINE=admix_bychr_noinv

#Working folder is core folder where this pipeline is being run.
WORKING_FOLDER=/scratch/perickso/private/ind_seq/popgen

#Final VCF file
IN_GZVCF=/scratch/perickso/private/ind_seq/popgen/zaprionus.individual.nosingleton.2023.withID.mac3.removeinv.vcf.gz
...
then
	...
	then
		...
		--make-bed \
		--double-id \
		--keep /scratch/perickso/private/ind_seq/popgen/admix.female \
		--allow-extra-chr \
		--chr Scaffold_${chr} \
