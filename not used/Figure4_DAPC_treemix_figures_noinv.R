...
c<-plot_treemix(edge4, plot.nodes=F) +theme(axis.title=element_text(size=14), vjust=1, axis.text=element_text(size=10))

pdf("/scratch/perickso/private/ind_seq/Figures/Figure4_DAPC_treemix_noinv.pdf", height=4, width=12)
