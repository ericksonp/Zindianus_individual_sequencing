...
write.csv(window.sum, file="/scratch/perickso/private/ind_seq/popgen/ihs_bp_fst_1kbwindows.csv")
...
write.csv(snptags, file="/scratch/perickso/private/ind_seq/popgen/ihs_bp_fst_1kbwindows_snpstoplot.csv")
