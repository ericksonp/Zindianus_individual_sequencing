...
a<-ggscatter.dapc(x=dapc_year)+scale_color_manual(values=friendly_pal("ito_seven")[c(1:4,6)])+theme_cowplot()
## treemix ###
...
edge0<-read_treemix("zaprionus.individual.nosingleton.2023.withID.mac3.removeinv.autosomesonly.noN.CM_MIA.plink.prune.pruneddata.treemix.frq.gz0")
edge1<-read_treemix("zaprionus.individual.nosingleton.2023.withID.mac3.removeinv.autosomesonly.noN.CM_MIA.plink.prune.pruneddata.treemix.frq.gz1")
edge2<-read_treemix("zaprionus.individual.nosingleton.2023.withID.mac3.removeinv.autosomesonly.noN.CM_MIA.plink.prune.pruneddata.treemix.frq.gz2")
edge3<-read_treemix("zaprionus.individual.nosingleton.2023.withID.mac3.removeinv.autosomesonly.noN.CM_MIA.plink.prune.pruneddata.treemix.frq.gz3")
edge4<-read_treemix("zaprionus.individual.nosingleton.2023.withID.mac3.removeinv.autosomesonly.noN.CM_MIA.plink.prune.pruneddata.treemix.frq.gz4")
edge5<-read_treemix("zaprionus.individual.nosingleton.2023.withID.mac3.removeinv.autosomesonly.noN.CM_MIA.plink.prune.pruneddata.treemix.frq.gz5")
...
c<-plot_treemix(edge3, plot.nodes=F) +theme(axis.title=element_text(size=14), vjust=1, axis.text=element_text(size=10))

pdf("/scratch/perickso/private/ind_seq/Figures/DAPC_treemix.pdf", height=4, width=12)

plot_grid(a,b,c, nrow=1, labels=c("A", "B", "C"), align="h", rel_widths=c(0.38, 0.26, 0.38))
dev.off()