...
snptags<-fread("/scratch/perickso/private/ind_seq/popgen/ihs_bp_fst_1kbwindows_snpstoplot_VA_ALL.csv")
...
jpeg("/scratch/perickso/private/ind_seq/Figures/Figure4_VAall_version.jpeg",  height=10, width=8, res=600, units="in")
left
