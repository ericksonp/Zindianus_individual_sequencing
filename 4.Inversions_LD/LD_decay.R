...
m<-foreach(focal.snp=info$snp.id, .errorhandling="remove")%dopar%{
  ...
  y<-foreach(dist=c(50000,75000, 100000, 150000, 200000, 250000, 300000, 400000, 500000), .errorhandling = "remove")%do%{
...
write.table(m, "/scratch/perickso/private/ind_seq/popgen/ld_decay_NorthAmerica.txt", quote=F, sep="\t", row.names = F)
